  ...
  const handleImageUpload = async (e: any) => {
    ...
    if (file) {
      ...
      try {
        ...
        updateMessage((prevMessages: any) => [...prevMessages, userMessage]);
        ...
        updateMessage((prevMessages: any) => [...prevMessages, errorMessage]);
      } finally {
...
const RenderMessage = ({ message, msgIndex, loading, messageLength }: any) => {
